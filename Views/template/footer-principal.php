...
<div class="copyright_section">
  <div class="container">
    <p class="copyright_text">DISTRIBUIDORA AMERICA 2024. Av. juliaca #92432432432 <?php echo date('Y'); ?> <a href="#"></a></p>
  </div>
</div>
  ...
  <div class="modal-dialog modal-lg">
    <div class="modal-content">
      ...
      <div class="d-flex justify-content-around mb-3">
        ...
        <?php } else { ?>
          <a class="btn btn-outline-primary" href="#" onclick="abrirModalLogin();">Iniciar Seccion</a>
        <?php } ?>
      </div>
    </div>
  </div>
        ...
        <div class="row">
          <div class="col-md-12" id="frmLogin">
            ...
            <div class="float-right">
              <button class="btn btn-primary" type="button" id="login">Iniciar Seccion</button>
            </div>
          </div>
