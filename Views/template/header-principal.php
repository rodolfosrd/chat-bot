...
<head>
   ...
   <!-- site metas -->
   <title>Distribuidora Las Americas</title>
   ...
   <style>
      ...
      /* Estilo para hacer el título más grande */
      .main_title {
         font-size: 36px; /* Cambia el tamaño del texto según sea necesario */
         font-weight: bold; /* Opcional: añade negrita */
      }
   ...
   <div class="banner_bg_main">
            ...
            <div class="row">
               <div class="col-sm-12">
                  <div class="custom_menu">
                     <ul>
                        <li><a href="#" class="main_title">Distribuidora Las Americas</a></li>
                     </ul>
                  </div>
               </div>
            </div>
      ...
      <div class="logo_section">
         <div class="container">
            <div class="row">
               <div class="col-sm-12">
                  <div class="logo"><a href="<?php echo BASE_URL; ?>"><img src="<?php echo BASE_URL; ?>assets/images/logo.jpg" width="105"></a></div>
                  <br>
                  <br>
               </div>
            </div>
